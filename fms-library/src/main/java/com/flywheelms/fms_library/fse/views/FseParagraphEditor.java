...
import com.flywheelms.fms_library.fse.enumerator.FseInsertModificationState;
...
import com.flywheelms.fms_library.fse.enumerator.FseParagraphContentType;
...
import com.flywheelms.fms_library.fse.model.FseDocumentSectionParagraphEditorContent;
...
import com.flywheelms.fms_library.fse.widget.GcgClickState;
...
//		renumberPeerParagraphs(theNewParagraphView);
    ...
    public void assureMinimumParagraph() {
        if (paragraphViewList.size() < 1) {
            FseParagraphView theParagraphView = newFseParagraphView(new FseParagraph(FseParagraphStyle.BODY_1, FseParagraphNumberingStyle.NONE, ""), this.isHistory);
            synchronizedParagraphAddLast(theParagraphView);
