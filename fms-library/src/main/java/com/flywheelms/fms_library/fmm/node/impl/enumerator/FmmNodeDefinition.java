...
package com.flywheelms.fms_library.fmm.node.impl.enumerator;
...
import com.flywheelms.fms_library.fmm.node.interfaces.FmmEnumNode;
...
import com.flywheelms.fms_library.fmm.transaction.FmmNodeGlyphType;
import com.flywheelms.fms_library.fse.model.FseDocument;
import com.flywheelms.fms_library.fse.model.FseDocumentTransaction;
import com.flywheelms.fms_library.fse.model.FseDocumentTransactionType;
import com.flywheelms.fms_library.fse.model.FseParagraph;
...
import static com.flywheelms.fms_library.fmm.helper.FmmHelper.getResources;
...
//        SERVICE_REQUEST.setPrimaryParentIdColumnName(ServiceRequestMetaData.column_SERVICE_OFFERING_ID);
	...
	FmmNodeDefinition(
		...
		this.dictionaryTermText = getResources().getString(this.dictionaryTermResourceId);
        this.dictionaryDefinitionResourceId = aDictionaryDefinitionResourceId;
        this.dictionaryDefinitionText = getResources().getString(this.dictionaryDefinitionResourceId);
		this.labelDrawableResourceId = aLabelDrawableResourceId;
		this.labelDrawable = getResources().getDrawable(this.labelDrawableResourceId);
