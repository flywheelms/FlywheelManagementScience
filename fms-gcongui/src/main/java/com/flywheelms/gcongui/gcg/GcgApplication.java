...
public abstract class GcgApplication extends Application {
	...
	protected static GcgApplication instance;
	...
	public GcgApplication() {
   	...
   	public static AudioManager getAudioManager() {
		return (AudioManager) GcgApplication.getContext().getSystemService(Context.AUDIO_SERVICE);
	}
    ...
    public static PackageManager getAppPackageManager() {
        return GcgApplication.getContext().getPackageManager();
    }

    public static AssetManager getAssetManager() {
        return GcgApplication.getContext().getAssets();
    }
    
    public static int getIntegerResource(int aResourceId) {
    	return GcgApplication.getContext().getResources().getInteger(aResourceId);
    }

    public static int getColorResource(int aResourceId) {
        return GcgApplication.getContext().getResources().getColor(aResourceId);
    }

	public static String getStringResource(int aResourceId) {
		return GcgApplication.getContext().getResources().getString(aResourceId);
	}
	...
	public static LayoutInflater getLayoutInflater() {
		return LayoutInflater.from(GcgApplication.getContext());
	}
	...
	public static InputMethodManager getInputMethodManager() {
		return (InputMethodManager) GcgApplication.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
	}
